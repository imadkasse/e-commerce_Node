...
const Footer = () => {
  return (
    <footer className="bg-[#304C89] font-sans tracking-wide">
          ...
          <div>
            <ul className="space-y-4">
              <li>
                <Link
                  href="/"
                  className="text-gray-300 hover:ml-2 transition-all hover:text-red-400 duration-500 text-sm"
                >
                  My Account
                </Link>
              </li>
              ...
              <li>
                <Link href="/" className="text-gray-300 hover:text-white">
                  <svg
                    ...
                    viewBox="0 0 24 24"
                  >
                    <path d="M21 5a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V5zm-2.5 8.2v5.3h-2.79v-4.93a1.4 1.4 0 0 0-1.4-1.4c-.77 0-1.39.63-1.39 1.4v4.93h-2.79v-8.37h2.79v1.11c.48-.78 1.47-1.3 2.32-1.3 1.8 0 3.26 1.46 3.26 3.26zM6.88 8.56a1.686 1.686 0 0 0 0-3.37 1.69 1.69 0 0 0-1.69 1.69c0 .93.76 1.68 1.69 1.68zm1.39 1.57v8.37H5.5v-8.37h2.77z" />
                  </svg>
                </Link>
              </li>
              <li>
      ...
      <div className="text-center py-5 bg-red-400">
        <p className="text-white text-lg">
          © eco website. All rights reserved.
        </p>
      </div>
    </footer>
  );
